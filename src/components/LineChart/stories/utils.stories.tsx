...
export const series = [
  ...
  },
  {
    name: 'Mar 01–Mar 14, 2020',
    data: [
      {rawValue: randomNumber(0, 20), label: '2020-03-02T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-01T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-03T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-04T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-05T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-07T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-06T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-08T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-09T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-10T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-11T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-12T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-13T12:00:00'},
      {rawValue: randomNumber(0, 20), label: '2020-03-14T12:00:00'},
    ],
  },
];
