...
export const Default: StoryFn<SparkLineChartProps> = Template.bind({});
Default.args = {
  ...defaultProps,
};

export const withoutSpline: StoryFn<SparkLineChartProps> = Template.bind({});
withoutSpline.args = {
  ...defaultProps,
  theme: 'NoSpline',
};

export const OffsetAndNulls: StoryFn<SparkLineChartProps> = Template.bind({});
OffsetAndNulls.args = {
  ...defaultProps,
  offsetRight: 12,
  offsetLeft: 50,
...
export const OverwrittenSeriesColors: StoryFn<SparkLineChartProps> =
  Template.bind({});
...
export const ZeroSeries: StoryFn<SparkLineChartProps> = Template.bind({});
ZeroSeries.args = {
  ...defaultProps,
  data: [
    {
