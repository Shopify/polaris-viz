import type {StoryFn} from '@storybook/react/types-6-0';
...
const Template: StoryFn<LineSeriesProps> = (args) => {
...
export const Default: StoryFn<LineSeriesProps> = Template.bind({});

Default.args = {
  ...props,
};

export const isComparison: StoryFn<LineSeriesProps> = Template.bind({});
