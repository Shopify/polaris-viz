...
export const InteractiveCustomLegend: StoryFn<ComboChartProps> = Template.bind(
  {},
);
...
export default {...META, title: 'polaris-viz/Charts/ComboChart/InteractiveCustomLegend'} as any;