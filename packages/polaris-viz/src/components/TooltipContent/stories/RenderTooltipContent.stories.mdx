...
<Title>🧪 Render Tooltip Content</Title>

Components that render tooltips provide a prop called <code>renderTooltipContent</code> that allows consumers to pass their own content to the tooltip.
