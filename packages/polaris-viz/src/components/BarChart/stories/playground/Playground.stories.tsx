...
const SingleValuesTemplate: StoryFnFn<BarChartProps> = (args: BarChartProps) => {
  return (
...
export const SingleSeriesMultipleBars: StoryFnFn<BarChartProps> = (
  args: BarChartProps,
) => {
  return (
    <div style={{width: 600, height: 400}}>
...
export const LotsOfSingleBars: StoryFn<BarChartProps> = (args: BarChartProps) => {
  return (
    <div style={{width: 600, height: 400}}>
      <BarChart {...args} />
    </div>
...
export const AnnotationMania: StoryFn<BarChartProps> = (args: BarChartProps) => {
  return (
    <div style={{width: 600, height: 400}}>
      <BarChart {...args} />
    </div>
...
export const PerformanceTest: StoryFn<BarChartProps> = (args: BarChartProps) => {
  return (
...
export const BadData: StoryFn<BarChartProps> = (args: BarChartProps) => {
  return (
    <div style={{width: 600, height: 400}}>
      <BarChart {...args} />
    </div>
...
export const InfinityData: StoryFn<BarChartProps> = (args: BarChartProps) => {
  return (
