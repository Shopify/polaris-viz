...
export default {
  ...META,
  title: 'polaris-viz/Charts/BarChart/Playground/ExternalTooltip',
  decorators: [],
} as any;
...
const TemplateWithFrame: StoryFn<BarChartProps> = (args: BarChartProps) => {
...
export const ExternalTooltip: StoryFn<BarChartProps> = Template.bind({});
export const ExternalTooltipWithFrame: StoryFn<BarChartProps> =
