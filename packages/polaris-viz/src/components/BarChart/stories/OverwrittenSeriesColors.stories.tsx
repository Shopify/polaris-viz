...
export const OverwrittenSeriesColors: StoryFn<BarChartProps> = Template.bind({});
...
export default {...META, title: 'polaris-viz/Charts/BarChart/OverwrittenSeriesColors'} as any;