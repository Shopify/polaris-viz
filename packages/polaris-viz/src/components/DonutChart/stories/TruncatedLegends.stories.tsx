...
export const TruncatedLegends: StoryFn<DonutChartProps> = TruncatedLegendsTemplate.bind({});
...
export default {...META, title: 'polaris-viz/Charts/DonutChart/TruncatedLegends'} as any;